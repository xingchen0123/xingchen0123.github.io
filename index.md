...
## Working Papers
- *"Addressing multitasking problems through promotion incentives", First author with [Hanchen Jiang](http://schpa.uibe.edu.cn/szdw/xxjs/xzglx/9b83fc2c01da4f1385242d764dbeaf3a.htm) and Jiaheng Ling. *Revise and Resubmit*, [[SSRN]](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4449612).*
  
  Abstract: This study builds a theoretical framework on how subnational governments use promotion schemes to motivate local bureaucrats to address conflicting tasks of economic development and environmental protection. We argue that subnational (province) governments can strategically allocate polluting industries to border areas to enjoy the benefits of economic development within their jurisdiction while shifting a portion of the pollution burden to the neighboring area, and use promotion incentives to make their subordinates (city leaders) comply. Hence, when the central government imposes a stricter environmental regulation policy on provincial governments, border-city leaders obtain a higher probability of promotion. Based on a panel dataset of leaders’ career information in China, we find an increase in promotion probability for border-city leaders after 2011 when the environmental protection emerged as a prominent political ideology for the ruling Chinese Communist Party. A potential channel is that border-city leaders accept the migration of polluting industries as a signal of compliance. Notably, this “border effect” for promotion is more prominent for newly appointed leaders who exhibit stronger political motivations and rely more on their superiors to get promoted.
  
- *"Pollution Matters: The Political Impact of Information Disclosure", First and Corresponding author with [Xiaoxiao Shen](https://xiaoxiaoshen.co/) and Andong Zhuge. *under review*, [[SSRN]](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4486089).*
  
  Abstract: The existing literature regarding the impacts of information disclosure and transparency on political trust has demonstrated mixed results. Thus, gaining a precise comprehension of the conditions under which information disclosure enhances or deceases political trust is of utmost importance. Using a Difference-in-Difference strategy, this paper examines the causal effect of environmental information disclosure on political trust in the case of China, by looking into a staggered rolled-out implementation of a national program in China that provides real-time air-pollution information to the public. We found that the disclosure of the environmental information had a significantly positive impact on citizens’ political trust towards the local government. However, this “disclosure effect” was moderated by the local pollution levels residents were exposed to. Notably and surprisingly, the adverse impact was more pronounced for less polluted areas. Our heterogeneity analysis also showed that the “disclosure effect” moderated by local pollution levels is more pronounced among middle-aged, internet using, and urban residents with children. Furthermore, we established that the influence of environmental information disclosure on political trust operated through the channels of citizens’ satisfaction towards the local government and their mental well-being. This paper seeks to contribute to the literature of information disclosure and political trust by (1) examining the causal impact of information disclosure on political trust, (2) providing a possible psychological mechanism through which the effect occurred, and (3) demonstrating the diverse “disclosure effect” in an authoritarian setting.
...
- *"The impact of grassroot democracy on hierarchical government trust in rural China", First author  with [Yuanyuan Yi](https://sites.google.com/view/yuanyuanyi/home), [Jintao Xu](https://en.nsd.pku.edu.cn/faculty/fulltime/x/239550.htm) and Andong Zhuge.*
  ...
  Abstract:This study explores how the application of the democratic rule in grassroot decision-making process determines villagers’ political trust in land reform in rural China. We use a two-period household survey data and find that in China’s most recent Collective Forest Tenure Reform, the use of democratic rule improves villagers’ trust for town and county cadres, whereas its impact on trust towards village cadres is not significant. This pattern of trust is partly explained by our findings that the democratic process helped decrease the unresolved inter-village forestland disputes which usually requires town or county level cadres’ to intervene, whilst there seems no such impact on the within-village land disputes. Heterogeneity analyses show that the use of the democratic rule in decision-making process has a more pronounced effect in improving trust for lower-income, and household without affiliation with the Chinese Communist Party (CCP) or to the village committee. Our results provide the first evidence that Chinese people perceive democracy not only as a way to select their leaders, but also ways for ordinary people to participate in public affairs and present their opinions in decision-making process to influence local cadres’ accountability in Chinese grassroots democracy.
...
- *"Public attitudes towards COVID policy", First author with [Jiakun Zheng](https://scholar.google.com/citations?user=c-6NWRcAAAAJ&hl=fr) and [Jianhua Xu](https://www.ghd.pku.edu.cn/English/People/Faculty_fe5100f8d50a4875a92ad8991380a172/X_fe5100f8d50a4875a92ad8991380a172/XUjianhua/index.blk.htm). *submitted*.*
    ...
    Abstract:The debate about the optimal policy to deal with a pandemic is yet to be settled. Against the backdrop that the clamor in social media always dominates the public sphere, it is of great importance to know the attitudes of the general public towards COVID policies. With a survey conducted in seven cities in China from August to September of 2022 – the months before China relaxed its COVID policy, we provide a detailed analysis of public preferences towards the zero-COVID policy with 7,000 valid responses. The results show that: (1) 80.54% of the respondents are zero-COVID supporters; (2) the choice of policy is shaped by individuals' perceptions of the associated costs and benefits, at both the self and societal levels. Also, respondents’ perceptions of self and societal cost for COVID policy are notably aligned; (3) The preference for zero-COVID varies across sociodemographic groups, specifically, people with a higher level of trust in government, higher level of risk aversion, no experience with economic loss, and no infection of COVID-19, are significantly more likely to be zero-COVID supporters.
...
- **Principles of Economics**
  Undergraduate Course. An introduction course to core concepts and theories of economics for newly admitted undergrads at Fudan.(Student evaluations: 93.1/100)
- **Quantitative Research Method**
  Undergraduate Course. An introduction course covering basic statistical analysis.(Student evaluations: 89.76/100)
- **Environmental policy and management**
  Undergraduate Course. This course provides an overview of China's environmental governance system. We will begin with a brief historical overview of China's environmental regulation development from 2000 to the present. (Student evaluations: 92.44/100)
- **Performance Evaluation in Public Sector**
  Undergraduate Course. An introductory course for causal inference, including Difference-in-difference(DID), instrumental variable method (IV), regression discontinuity design(RDD), and synthetic control methond (SCM).(Student evaluations: 95.87/100)
- **Public Economics**
  MPA course
