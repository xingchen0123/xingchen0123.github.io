...
- From Scarcity to Spike: The Impact of Childhood Famine Trauma on Fiscal Expenditure Behavior (Corresponding author with Andong Zhuge). [[ssrn]](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4646240)[[slides]](https://www.dropbox.com/scl/fi/t819mhqoujxse6sr7pw0s/trauma.pdf?rlkey=a9t50sj9rtcagp90wfre37dfj&dl=0). Under Review
  <details><summary>Abstract:</summary>
...
- Bridging trust through institution and process: the causal effect of e-government on political trust (with [Hanchen Jiang](http://schpa.uibe.edu.cn/szdw/xxjs/dpa/409af343e573423d9fecc98e39474c7e.htm))
  <details><summary>Abstract:</summary>
   The role of e-government in enhancing citizen-government interactions is promising, but its impact on citizens’ political trust is still unclear. This study integrates institution-based and process-based trust theories to examine e-government’s influence on political trust. The institution-based trust theory suggests that e-government boosts political trust by improving citizens’ perceptions of the institutional features of government, regardless of how often citizens use public services. Meanwhile, the process-based trust theory argues that e-government increases political trust among frequent users by enhancing public service efficiency and user experience. Utilizing a representative longitudinal survey dataset from China and a difference-in-difference strategy, we identify the causal effect that e-government increases citizens’ political trust. Additionally, we reveal two main mechanisms underlying this effect. First, e-government improves citizens’ satisfaction with government performance and confidence in future, and reduces their concerns about social security and inequality, supporting the institution-based trust theory. Second, e-government’s impact on political trust is more pronounced for those with higher public service demands, consistent with process-based trust theory. Finally, contrary to the digital divide theory, our findings indicate that e-government benefits are widespread, reaching beyond digitally proficient individuals to include less digitally skilled demographics. This challenges the established beliefs and highlights the inclusive potential of e-government.
  </details>
