...
My experience at Shanghai ignited my interest in understanding heterogeneous public attitudes towards public policy. My research is interdisciplinary, bridging the gaps between political science, public policy, and public administration. Currently I am working on topics including **Public Opinion, Environmental Politics, and Political Economy**, with the regional focus on China. I provide evidence-based insights into how information, trauma, media, and cultural norms shape political trust and decision making. My research has appeared or is forthcoming in **Governance**, **Public Performance&Management Review**, among others. If you want to collaborate, feel free to email me.
...
- The Dynamics of Public Opinion on COVID-19 Policies in China
 (First author  with [Jiakun Zheng](https://scholar.google.com/citations?hl=zh-CN&user=c-6NWRcAAAAJ), [Jianhua Xu](https://www.ghd.pku.edu.cn/English/People/Faculty_fe5100f8d50a4875a92ad8991380a172/X_fe5100f8d50a4875a92ad8991380a172/XUjianhua/index.blk.htm) and [Yana Jin](http://scholar.pku.edu.cn/yjin/bio)). 
  <details><summary>Abstract:</summary>
   This study examines the public response to the transition from zero-COVID to live-with-COVID policies in China, using a two-wave panel survey from August 2022 and January 2023. Initial support for zero-COVID was high (79.42%) and remained significant (45.73%) post-relaxation. Sociodemographic factors had minimal influence on policy support, except for iOS users. People's attitudes towards COVID policies correlate with their perceived personal costs and benefits, contradicting the passive acceptance or self-censorship hypothesis. The relation between the severity of COVID-19 symptoms and zero-COVID policy support demonstrates the role of personal experience in shaping public opinion, highlighting heterogeneous preferences towards COVID policies in China.
  </details>

- From Scarcity to Spike: The Impact of Childhood Famine Trauma on Fiscal Expenditure Behavior (with Andong Zhuge). [[ssrn]](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4646240)[[slides]](https://www.dropbox.com/scl/fi/t819mhqoujxse6sr7pw0s/trauma.pdf?rlkey=a9t50sj9rtcagp90wfre37dfj&dl=0). under review
  <details><summary>Abstract:</summary>
   This research investigates the link between childhood famine experiences and fiscal conservatism in Chinese city officials from 2008 to 2018. We find that officials imprinted with childhood famine trauma demonstrate a significant increase in Year-End Spending Spikes (YESS), a phenomenon characterized by a rush to exhaust surplus budgets at year end due to “use it or lose it” budget rule. This behavior correlates with reduced GDP growth rate and fiscal efficiency. The imprint effect is pronounced among officials aged 3-8 during the famine, suggesting a critical window of impressionable years. Moreover, working in cities less reliant on financial transfers, and extensive local networks accentuate this effect.We further explore the psychological mechanisms, highlighting a correlation between mild depression and fiscal behavior, thus providing new insights into the profound and enduring effects of early trauma experiences on public financial management.
  </details>
...
- Bridging trust through institution and process: the causal effect of e-government on political trust (with [Hanchen Jiang](http://schpa.uibe.edu.cn/szdw/xxjs/dpa/409af343e573423d9fecc98e39474c7e.htm)).under review
  <details><summary>Abstract:</summary> 
   This study assesses e-government's impact on political trust, merging institution-based and process-based trust theories. Institution-based theory suggests e-government enhances political trust by improving institutional perceptions, independent of public service usage frequency. Conversely, process-based theory posits e-government bolsters trust among frequent users by elevating service efficiency and experience. Analyzing a longitudinal survey from China using a difference-in-difference strategy, we find e-government causally increases political trust. This effect stems from enhanced satisfaction with government performance, increased confidence, and reduced concerns about social issues, aligning with institution-based theory. Additionally, the impact is greater for those with higher service demands, supporting process-based theory. Contrary to digital divide concerns, our results show e-government benefits extend to both digitally proficient and less skilled individuals, suggesting its inclusive potential and challenging traditional beliefs.
  </details>
...
- “The Voice of Extravagance”: Evidence from Cross-Border Media Exposure in Pearl River Delta(Corresponding author with [Renji Zhou](https://ii.umich.edu/ii/people/all/r/renjizh.html))
  <details><summary>Abstract:</summary>
   This study examines the political impact of non-political entertainment media, using the accidental reception of Hong Kong TV in rural Guangdong during the 1980s as a natural experiment. In areas lacking cable services, rural residents often used alternative means to access TV, creating a unique context. Using the Irregular Terrain Model for signal estimation and a longitudinal panel dataset with a cohort difference-in-difference approach, we observe a significant decline in political trust among rural residents exposed to Hong Kong TV, especially those in adolescence during exposure. Exposure to media showcasing concepts like gender equality and justice appears to foster critical thinking, increase civic consciousness, and heighten social issue awareness, challenging authoritarian views. This highlights the subtle yet profound influence of democratic-region entertainment media on individuals in authoritarian settings.
  </details>
