...
## Publications
- **Chen, Xing**, [Xiaoxiao Shen](https://xiaoxiaoshen.co/), and Andong Zhuge. 2023. "Pollution Matters: The Political Cost of Information Disclosure". ***Governance***. [[link]](https://onlinelibrary.wiley.com/doi/10.1111/gove.12847), [[ssrn]](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4486089)
...
- Enhancing trust through institution and service process: the causal effect of digital government policy on political trust （with [Hanchen Jiang](http://schpa.uibe.edu.cn/szdw/xxjs/dpa/409af343e573423d9fecc98e39474c7e.htm))
  <details><summary>Abstract:</summary>
   Digital government’s role in enhancing citizen-government interactions holds much promise, yet its effect on citizens’ political trust remains inconclusive. This study integrates institution-based and process-based theoretical perspectives to explore how digital government influences political trust. Utilizing a representative longitudinal survey dataset from China and a difference-in-differences strategy, we identify two key mechanisms by which e-government enhances political trust. Firstly, increased governmental transparency, intrinsic to digital governance, significantly improves citizens’ perceptions of institutional structure and systematic functionality, consequently boosting political trust. This finding supports institution-based trust theory. Secondly, digital government initiatives, through expanded Internet access and streamlined public service delivery, improve public service quality and accessibility, reducing concerns about social security and inequality, and fostering perceptions of governmental efficacy and responsiveness. Moreover, heterogeneity analysis shows that digital government’s impact is more pronounced among those with greater public service needs, aligning with process-based trust theory. Finally, contrary to the digital divide theory, our findings indicate that the benefits of digital government are not confined to the digitally proficient but extend across various demographic groups, including those with limited digital skills. This challenges traditional assumptions and highlights the inclusive potential of digital government transformation.
  </details>
