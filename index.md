...
My experience at Shanghai ignited my interest in politics, diverging from my initial academic path. Through diligent self-study, I now delve into **Public Opinion, Political Psychology, and Environmental Politics**. Leveraging observations from the real world, I provide evidence-based insights into how information, trauma, and cultural norms shape political trust and decision-making in contemporary China, with a particular focus on individuals' psychological responses to various stimuli. My interdisciplinary research connects public policy/administration, political science, and economics, with publications in  **Governance**, **Public Performance&Management Review**. If you want to collaborate, feel free to email me.
...
- Bridging trust through institution and process: the causal effect of e-government on political trust (with [Hanchen Jiang](http://schpa.uibe.edu.cn/szdw/xxjs/xzglx/32b832e6a5fd4c61a50c7a0924a5cd1b.htm)).under review
