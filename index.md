...
My experience at Shanghai ignited my interest in politics, diverging from my initial academic path. Through diligent self-study, I now delve into **Public Opinion, Political Psychology, and Environmental Politics**. Leveraging observations from the real world, I provide evidence-based insights into how information, trauma, and cultural norms shape political trust in contemporary China, with a particular focus on individuals' psychological responses to various stimuli. My interdisciplinary research connects public policy/administration, political science, and economics, with publications in  **Governance**, **Public Performance&Management Review**. If you want to collaborate, feel free to email me.
